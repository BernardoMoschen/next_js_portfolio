...
const SectionDivider: React.FC<SectionDividerProps> = ({ flip = false, className }) => {
        ...
        >
            ...
            >
                <defs>
                    ...
                    <linearGradient id={`shimmer-${id}`} x1="0%" y1="0%" x2="200%" y2="0%">
                    ...
                    <radialGradient id={`bloom-${id}`} cx="50%" cy="50%" r="60%">
                ...
                {/* Background bloom */}
                <rect x="0" y="0" width="1440" height="60" fill={`url(#bloom-${id})`} />
